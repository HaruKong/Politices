...
public class MyLoadMoreRecyclerView extends RecyclerView {
    ...
    public final static int TYPE_HEADER = 1;//ͷ��--֧��ͷ������һ��headerView
    public final static int TYPE_FOOTER = 2;//�ײ�--������һ��loading_more

    private boolean mIsFooterEnable = false;//�Ƿ�������ظ��
